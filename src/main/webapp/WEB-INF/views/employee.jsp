  ...
  <div class="rounded">
    <main class="container clear"> 
	  ...
	  <% if(request.getParameter("msg") != null) { %>
		...
		<% } %>
        <form action="model/employee" method="post">
		...
		<div class="one_third">
            <label for="email">Employee Status<span>*</span></label>
	  ...
	  <div style="clear:both"></div>
          ...
          <div class="block clear"></div>
		   <h4>Employee Role & Manager</h4>
		    <div class="one_third first">
            <label for="email">Employee Role<span>*</span></label>
           ...
           <div class="one_third">
            <label for="email">Employee Manager Code<span>*</span></label>
