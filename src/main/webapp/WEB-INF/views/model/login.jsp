...
<%@ page import="com.riteship.campus.recruitment.systems.application.entities.Login" %>
...
<%
	...
	if((request.getParameter("act")).equals("chk_login"))
	{
		...
		{
			response.sendRedirect("redirectToChangePassword?msg=Invalid User/Password. Please try again.........");
		}
	}
	...
	{		
		...
		{
			response.sendRedirect("redirectToChangePassword?msg=Your Password has been changed successfully.");
		}
		else
		{
			response.sendRedirect("redirectToChangePassword?msg=Old Password doesnot match. Please try again......");
		}
	}
	if((request.getParameter("act")).equals("logout"))
	{
		...
		response.sendRedirect("redirectToLogin?msg=You are logout successfully......");
	}
%>
